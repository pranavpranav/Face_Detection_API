...
namespace Face_Api_Demo
{
    ...
    {
        private readonly IFaceServiceClient _faceServiceClient = new FaceServiceClient("5972694a74b4494abc6f901ae4f00c1e", "https://facedemoapi.cognitiveservices.azure.com/face/v1.0");
        public MainWindow()
        {
            InitializeComponent();
        }
